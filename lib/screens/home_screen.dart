        ...
        return StatefulBuilder(
          ...
          return Dialog(
            insetPadding: EdgeInsets.symmetric(
              horizontal: MediaQuery.of(context).size.width > 600 ? 40 : 8,
              vertical: 24,
            ),
              elevation: 0,
              backgroundColor: Colors.transparent,
              child: Container(
                width: MediaQuery.of(context).size.width > 600 ? 750 : double.infinity,
                constraints: BoxConstraints(
                  maxWidth: 900,
                  maxHeight: MediaQuery.of(context).size.height * 0.9,
                ),
                padding: EdgeInsets.all(MediaQuery.of(context).size.width > 600 ? 28 : 20),
                    ...
                    children: [
                      Container(
                        ...
                        child: Icon(
                          ...
                          size: MediaQuery.of(context).size.width > 600 ? 48 : 40,
  ...
  Widget _buildGoalModalContent(
    ...
    return Column(
      children: [
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        fontSize: 14,
                        fontWeight: FontWeight.w600,
                        color: stopDate == null ? const Color(0xFF94A3B8) : const Color(0xFF0F172A),
                      ),
                    ),
                  ],
                ),
              ...
              TextButton(
                onPressed: () async {
                  final results = await showCalendarDatePicker2Dialog(
                    ...
                    dialogSize: Size(
                      MediaQuery.of(context).size.width > 600 ? 350 : MediaQuery.of(context).size.width * 0.85,
                      450
                    ),
        ...
        const Row(
          children: [
            Icon(Icons.info_outline, size: 20, color: Color(0xFF475569)),
            SizedBox(width: 12),
            Expanded(
              child: Text(
  ...
  Widget _buildProfileCard() {
    ...
    List<Widget> _getBadges() {
      ...
      if (stopDate != null) {
        ...
        if (days >= 7) {
          badges.add(_buildBadge('7 dias', Icons.emoji_events, const Color(0xFFF59E0B)));
        }
        if (days >= 30) {
          badges.add(_buildBadge('1 mês', Icons.star, const Color(0xFF10B981)));
        }
        if (days >= 365) {
          badges.add(_buildBadge('1 ano', Icons.workspace_premium, const Color(0xFFEF4444)));
        }
      }
      return badges;
    }
