...
import 'historico_turma_modal.dart';
import 'dart:async';
...
class _EnfermeiraScreenState extends State<EnfermeiraScreen> {
  ...
  final List<String> _tabTitles = ['Dashboard', 'Usuários', 'Cronogramas', 'Lista de Presença'];

  String _statusFiltro = 'todos'; 
  List<Map<String, dynamic>> get _filtros => [
    {'valor': 'todos', 'label': 'Todos', 'cor': const Color(0xFF64748B)},
    {'valor': 'em_espera', 'label': 'Em Espera', 'cor': _warningColor},
    {'valor': 'matriculado', 'label': 'Matriculados', 'cor': _successColor},
    {'valor': 'cancelada', 'label': 'Cancelados', 'cor': _dangerColor},
  ];
  ...
  Future<bool?> _showConfirmDeleteDialog({
    ...
    Color confirmColor = const Color(0xFFC65D47),
  }) {
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        '${turma['vagas_ocupadas']}/${turma['vagas_totais']} alunos',
            ...
            ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  ...
                  trailing: IconButton(
                    icon: const Icon(Icons.delete_outline, color: Color(0xFFC65D47)),
                    ...
                    Row(
                      children: [
                        Container(
                          ...
                          child: const Icon(Icons.calendar_month, color: Color(0xFF1F4E6E), size: 24),
                        ),
                        const SizedBox(width: 12),
                        const Text(
                          'Adicionar Aula',
                          ...
                          child: ElevatedButton(
                            onPressed: () async {
                              ...
                              try {
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(content: Text('Aula adicionada com sucesso!'), backgroundColor: _successColor),
                                );
                              } catch (e) {
                                ScaffoldMessenger.of(context).showSnackBar(
  ...
  void _confirmarDeletarAula(int turmaId, int aulaId) async {
    ...
    if (confirm == true) {
      try {
        ...
        _recarregarTurmasCronograma();
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Aula excluída com sucesso!'), backgroundColor: _successColor),
        );
      } catch (e) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Erro: $e'), backgroundColor: Colors.red),
          ...
          Row(
            children: [
              ...
              Column(
                ...
                children: [
                  Text(
                    isMobile ? 'Painel Enfermeira' : 'Painel Enfermeira • $_upaNome',
                    style: const TextStyle(
                      color: Colors.white,
                      fontSize: 20,
                      fontWeight: FontWeight.w700,
      ...
      builder: (context, setState) {
        ...
        Future<void> salvarPresencas() async {
          ...
          try {
            ...
            if (mounted) {
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text('Presenças salvas com sucesso!'), backgroundColor: _successColor),
              );
            }
                          ...
                          Wrap(
                            ...
                            children: [
                              Container(
                                ...
                                child: Text(
                                  ...
                                  style: TextStyle(
                                    fontSize: 12,
                                    fontWeight: FontWeight.w600,
                                    color: vagasOcupadas >= vagasTotais ? Colors.red : _successColor,
                                  ),
                                ),
                              ),
                              OutlinedButton.icon(
                                ...
                                label: const Text('Cronograma', style: TextStyle(fontSize: 11, color: Color(0xFF1F4E6E))),
                                style: OutlinedButton.styleFrom(
                              ...
                              OutlinedButton.icon(
                                ...
                                label: const Text('Histórico', style: TextStyle(fontSize: 11, color: Color(0xFF1F4E6E))),
                                style: OutlinedButton.styleFrom(
                                  side: BorderSide(color: _accentColor),
                                  padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 6),
                                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                          ...
                          Row(
                            children: [
                              ...
                              OutlinedButton.icon(
                                onPressed: () => _verCronogramaTurma(turma),
                                icon: Icon(Icons.calendar_month, size: 16, color: _accentColor),
                                label: const Text('Cronograma', style: TextStyle(fontSize: 12, color: Color(0xFF1F4E6E))),
                                style: OutlinedButton.styleFrom(
                                  side: BorderSide(color: _accentColor),
                                  padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 6),
                                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                              ...
                              OutlinedButton.icon(
                                onPressed: () => _abrirHistoricoTurma(turma),
                                icon: Icon(Icons.history, size: 16, color: _accentColor),
                                label: const Text('Histórico', style: TextStyle(fontSize: 12, color: Color(0xFF1F4E6E))),
                                style: OutlinedButton.styleFrom(
                                  side: BorderSide(color: _accentColor),
                                  padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 6),
                                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                    ...
                    Row(
                      ...
                      children: [
                        OutlinedButton.icon(
                          ...
                          label: Text(isMobile ? 'Encerrar' : 'Encerrar Turma'),
                          style: OutlinedButton.styleFrom(
                        ...
                        ElevatedButton.icon(
                          ...
                          label: Text(isMobile ? 'Salvar' : 'Salvar Presenças'),
                          style: ElevatedButton.styleFrom(
                            backgroundColor: _successColor,
                            padding: EdgeInsets.symmetric(horizontal: isMobile ? 12 : 16, vertical: 10),
                            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
...
Expanded(
        ...
        children: [
          Row(
            children: [
              ...
              const SizedBox(width: 12),
              Expanded(child: _buildStatCard('Em Espera', data['totalEmEspera'].toString(), Icons.hourglass_empty, _warningColor)),
            ],
          ),
          const SizedBox(height: 12),
          Row(
            children: [
              Expanded(child: _buildStatCard('Matriculados', data['totalMatriculados'].toString(), Icons.check_circle, _successColor)),
              const SizedBox(width: 12),
              Expanded(child: _buildStatCard('Cancelados', data['totalCancelados'].toString(), Icons.cancel, _dangerColor)),
            ],
          ),
        ],
      );
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          Text(value, style: TextStyle(fontSize: isMobile ? 20 : 24, fontWeight: FontWeight.w700, color: Color(0xFF0F172A))),
          const SizedBox(height: 4),
          Text(title, style: TextStyle(fontSize: isMobile ? 10 : 12, color: Color(0xFF64748B))),
        ],
      ),
    );
  }
        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(value, style: TextStyle(fontSize: isMobile ? 12 : 14, fontWeight: FontWeight.w600, color: Color(0xFF0F172A))),
                Text(title, style: TextStyle(fontSize: isMobile ? 9 : 11, color: Color(0xFF64748B))),
              ],
            ),
          ),
        ],
  ...
  Color _getStatusColor(String status) {
    switch (status) {
      case 'em_espera': return _warningColor;
      case 'confirmada': return _successColor;
      case 'matriculado': return const Color(0xFF6B21A8);
      case 'recusada': return Colors.red;
      case 'cancelada': return _dangerColor;
