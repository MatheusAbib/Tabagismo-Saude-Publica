            ...
            child: Row(
              children: [
                Expanded(
                  child: Column(
                    children: [
                      Icon(Icons.calendar_month, size: 18, color: _accentColor),
                      const SizedBox(height: 4),
                      const Text('Início', style: TextStyle(fontSize: 10, color: Color(0xFF64748B), fontFamily: 'Inter')),
                      const SizedBox(height: 2),
                      Text(dataInicio, style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: Color(0xFF0F172A), fontFamily: 'Inter')),
                    ],
                  ),
                ),
                ...
                Expanded(
                  child: Column(
                    children: [
                      Icon(Icons.class_, size: 18, color: _accentColor),
                      const SizedBox(height: 4),
                      const Text('Total', style: TextStyle(fontSize: 10, color: Color(0xFF64748B), fontFamily: 'Inter')),
                      const SizedBox(height: 2),
                      Text('$totalAulas', style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: Color(0xFF0F172A), fontFamily: 'Inter')),
                    ],
                  ),
                ),
                Container(width: 1, height: 35, color: const Color(0xFFE2E8F0)),
                Expanded(
                  child: Column(
                    children: [
                      Icon(Icons.timer_outlined, size: 18, color: _accentColor),
                      const SizedBox(height: 4),
                      const Text('Duração', style: TextStyle(fontSize: 10, color: Color(0xFF64748B), fontFamily: 'Inter')),
                      const SizedBox(height: 2),
                      const Text('6 meses', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: Color(0xFF0F172A), fontFamily: 'Inter')),
                    ],
                  ),
                ),
              ],
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: Icon(Icons.timer, color: _successColor, size: 18),
                  ),
                  ...
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Próxima Aula', style: TextStyle(fontSize: 10, color: _successColor, fontFamily: 'Inter', fontWeight: FontWeight.w600)),
                        Text(
                          '${proximaAula['data_formatada']} às ${proximaAula['horario']}',
                          style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w700, color: Color(0xFF0F172A), fontFamily: 'Inter')),
                      ],
                    ),
                  ),
                ],
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Icon(Icons.access_time, size: 11, color: const Color(0xFF64748B)),
